...
class ProfessionalShopDealsList{
    private $Main;
     function __construct()
    {
        $this->Main=new Main;
        $this->Main->SetTitle("My Deals List");
        ...
        <script type="module" src="'.VIEW_PATH.'js/UserDashboard/Deals/DealsList.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuProfessional("UserDashboard/Deals/DealsList.phtml");
