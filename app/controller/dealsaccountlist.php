...
class dealsAccountList{
    private $Main;
     function __construct()
    {
        $this->Main=new Main;
        $this->Main->SetTitle("Deals Account List");
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/Tables/DealsAccountList.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuAdmin("Tables/DealsAccountList.phtml");
