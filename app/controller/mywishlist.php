...
class MyWishList{
     ...
     function __construct()
    {
        ...
        $this->Main->SetTitle("My Wish List");
        ...
        $Js='
        <script type="module" src="'.VIEW_PATH.'js/UserDashboard/WishList/WishList.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenu("UserDashboard/WishList/WishList.phtml",true,[
    ...
    if($type=='userBusiness'){
       ...
       $this->Main->CreateViewHeaderFooterSideMenuBusiness("UserDashboard/WishList/WishList.phtml",true,[
    ...
    if($type=='userProfessional'){
       ...
       $this->Main->CreateViewHeaderFooterSideMenuProfessional("UserDashboard/WishList/WishList.phtml",true,[
