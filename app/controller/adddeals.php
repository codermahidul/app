...
class AddDeals{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/BusinessDashboard/Deals/Add.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuBusiness("BusinessDashboard/Deals/Add.phtml",true,[
           "listHref"=>"DealsList",
           "list"=>"Deals List",
       ]);
