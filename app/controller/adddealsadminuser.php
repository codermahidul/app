...
class addDealsAdminUser{
    private $Main;
     function __construct()
    {
        $this->Main=new Main;
        $this->Main->SetTitle("New Deals");
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/Tables/AddDealsUser.js?v='.VERSION.'"></script>';
        ...
        $id=$url[count($url)-1];
        $this->Main->CreateViewHeaderFooterSideMenuAdminUserView("BusinessDashboard/Deals/Add.phtml",true,[
