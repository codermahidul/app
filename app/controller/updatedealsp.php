...
class updateDealsP{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/ProfessionalDashboard/Tables/EditDeals.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuProfessional("BusinessDashboard/Deals/Edit.phtml",true,[
           "listHref"=>"DealsListP",
           "list"=>"Deals List",
       ]);
