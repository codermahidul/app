...
class interviewBooking{
    ...
    {
        $this->Main=new Main;
        $this->Main->SetTitle("Interview Booking");
        ...
        $Js='
        <script type="module" src="'.VIEW_PATH.'js/TeamDashboard/Booking/Book.js?v='.VERSION.'"></script>';
        ...
        $this->Main->CreateViewHeaderFooterSideMenuTeam("TeamDashboard/Booking/BookList.phtml",true,[
            "Href"=>"AddBooking",
