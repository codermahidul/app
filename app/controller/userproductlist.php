...
class userProductList
{
    ...
    {
        $this->Main = new Main;
        $this->Main->SetTitle("User Product List");
        ...
        <script type="module" src="' . VIEW_PATH . 'js/Admin/Tables/UserProductShow.js"></script>';
        ...
        $this->Main->CreateViewHeaderFooterSideMenuAdmin(
            "Tables/MyProductAdmin.phtml",
            true,
            [
                "add_address" => "AddProductAdminUser/" . $id,
            ]
        );
    }
}
