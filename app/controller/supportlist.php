...
class supportList{
     ...
     function __construct()
    {
        ...
        $this->Main->SetTitle("Support List");
        ...
        <script type="module" src="'.VIEW_PATH.'js/Support/SupportList.js?v='.VERSION.'"></script>';
        $this->Main->SetJs($Js);
        ...
        switch($type)
        {
            case "userBusiness":{
                ...
                $this->Main->CreateViewHeaderFooterSideMenuBusiness("Support/SupportList.phtml");
            ...
            case "userProfessional":{
                ...
                $this->Main->SetHeaders($Header);
                $this->Main->SetFooter($Footer);
                $this->Main->CreateViewHeaderFooterSideMenuProfessional("Support/SupportList.phtml");
            ...
            case "user":{
                ...
                $this->Main->SetHeaders($Header);
                $this->Main->SetFooter($Footer);
                $this->Main->CreateViewHeaderFooterSideMenu("Support/SupportList.phtml");
