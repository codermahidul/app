...
class businessWorked{
    private $Main,$Curls;
     function __construct()
    {
        $this->Main=new Main;
        $this->Curls=new Curls;
        $this->Main->SetTitle("Business Worked");
        ...
        $Js='<script type="module" src="'.VIEW_PATH.'js/ProfessionalDashboard/Business/BusinessWorked.js?v='.VERSION.'"></script>
        ...
        $this->Main->CreateViewHeaderFooterSideMenuProfessional("ProfessionalDashboard/BusinessWorked/WorkedList.phtml");
    }
}
