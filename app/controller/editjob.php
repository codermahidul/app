...
class editJob{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/BusinessDashboard/Job/Edit.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuBusiness("BusinessDashboard/Job/Edit.phtml",true,[
           "listHref"=>"JobList",
           "list"=>"Job List",
       ]);
