...
class AddJobP{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/ProfessionalDashboard/Tables/AddJob.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuProfessional("BusinessDashboard/Job/Add.phtml",true,[
           "listHref"=>"JobListP",
           "list"=>"Job List",
       ]);
