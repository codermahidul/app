...
class AddJob{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/BusinessDashboard/Job/Add.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuBusiness("BusinessDashboard/Job/Add.phtml",true,[
           "listHref"=>"JobList",
           "list"=>"Job List",
       ]);
