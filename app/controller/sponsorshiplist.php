...
class sponsorshipList{
    private $Main;
    function __construct()
    {
        $this->Main=new Main;
        $this->Main->SetTitle("Sponsorship List");
        ...
        <script type="module" src="'.VIEW_PATH.'js/Sponsorship/SponsorshipAdminList.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuAdminUserView("Sponsorship/SponsorshipAdmin.phtml");
