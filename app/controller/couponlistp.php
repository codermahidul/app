...
class couponListP{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/ProfessionalDashboard/Tables/Coupon.js?v='.VERSION.'"></script>';
     ...
     //  $this->Main->CreateViewHeaderFooterSideMenuProfessional("ProfessionalDashboard/Tables/CouponList.phtml");
     $this->Main->CreateViewHeaderFooterSideMenuProfessional("BusinessDashboard/Coupon/CouponList.phtml",true,[
        "urlAdd"=>"AddCouponP"
    ]);
