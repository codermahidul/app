...
class addCouponAdminUser{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/Tables/AddCouponUser.js?v='.VERSION.'"></script>';
        ...
        $id=$url[count($url)-1];
       $this->Main->CreateViewHeaderFooterSideMenuAdminUserView("BusinessDashboard/Coupon/Add.phtml",true,[
