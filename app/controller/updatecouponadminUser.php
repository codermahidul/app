...
class updateCouponAdminUser{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/Tables/EditCouponUser.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuAdminUserView("BusinessDashboard/Coupon/Edit.phtml",true,[
           "listHref"=>"UserCouponList/".$id,
           "list"=>"Coupon List",
       ]);
