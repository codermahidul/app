...
class userDealsList{
    ...
    {
        $this->Main=new Main;
        $this->Main->SetTitle("User Deals List");
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/Tables/UserDealsShow.js?v='.VERSION.'"></script>';
        ...
        $this->Main->CreateViewHeaderFooterSideMenuAdmin("Tables/MyDealsAdmin.phtml",true,[
         "add_address"=>"AddDealsAdminUser/".$id,
        ]);
