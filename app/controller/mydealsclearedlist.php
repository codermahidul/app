...
class myDealsClearedList{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/BusinessDashboard/Deals/MyDealsClearedList.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuBusiness("Admin/Tables/DealsClearedList.phtml");
