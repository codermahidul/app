...
class updateCoupon{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/BusinessDashboard/Coupon/Edit.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuBusiness("BusinessDashboard/Coupon/Edit.phtml",true,[
           "listHref"=>"CouponList",
           "list"=>"Coupon List",
       ]);
