...
class dealsListP{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/ProfessionalDashboard/Tables/Deals.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuProfessional("ProfessionalDashboard/Tables/DealsList.phtml");
