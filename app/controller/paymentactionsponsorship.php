...
class paymentActionSponsorship
{
    ...
    function __construct()
    {
        ...
        if (!empty($_POST['stripeToken'])) {
            ...
            $price = $this->GetData->CalculatePriceSponsorship($item_id);
            ...
            if (isset($_POST['discount_code']) && $price > 0) {
                ...
                if ($price <= 0) {
                    ...
                    $this->GetData->HandelToken("Sponsorship/updateRequest", [
                        "payment" => '1',
                        "idSearch" => $item_id
                    ]);
                }
            ...
            if ($price > 0) {
                ...
                if (empty($api_error) && $customer) {
                    ...
                    if ($chargeJson['paid'] && $chargeJson['status'] == 'succeeded') {
                        ...
                        $fg = $this->GetData->HandelToken("Sponsorship/updateRequest", [
                            "payment" => '1',
                            "idSearch" => $item_id
                        ]);
                    } else {
