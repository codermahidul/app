...
class editAdSetting{
    ...
    {
        $this->Main=new Main;
        $this->Main->SetTitle("Edit Ad Setting");
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/Ad/Edit.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuAdmin("Ad/Add.phtml",true,[
           "listHref"=>"AdSettingList",
           "list"=>"Ad Setting List",
           "PageTitle"=>"Ad Option",
           "idSearch"=>"true",
       ]);
