...
class confirmVerify{
    ...
    {
        $this->Main=new Main;
        $this->Main->SetTitle("Confirm Verify");
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/BusinessUser/ConfirmVerify.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuAdmin("BusinessUser/ConfirmVerify.phtml");
