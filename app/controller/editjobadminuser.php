...
class editJobAdminUser{
    private $Main;
     function __construct()
    {
        $this->Main=new Main;
        $this->Main->SetTitle("Edit Job");
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/Tables/EditJobUser.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuAdmin("Tables/EditJobAdmin.phtml",true,[
