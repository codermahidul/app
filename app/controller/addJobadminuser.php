...
class addJobAdminUser{
    private $Main;
     function __construct()
    {
        $this->Main=new Main;
        $this->Main->SetTitle("New Job");
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/Tables/AddJobUser.js?v='.VERSION.'"></script>';
        ...
        $id=$url[count($url)-1];
        $this->Main->CreateViewHeaderFooterSideMenuAdminUserView("BusinessDashboard/Job/Add.phtml",true,[
           "listHref"=>"UserJobList/".$id,
           "list"=>"Job List",
        ]);
