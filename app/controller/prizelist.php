...
class prizelist{
     ...
     function __construct()
    {
        ...
        $Css='<link rel="stylesheet" href="'.VIEW_PATH.'css/UserDashboard/Forum/Forum.css">
        ...
        <script type="module" src="'.VIEW_PATH.'js/BusinessDashboard/Prize/Prize.js"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuBusiness("BusinessDashboard/Prize/PrizeList.phtml");
