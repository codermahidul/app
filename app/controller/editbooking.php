...
class editBooking{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/TeamDashboard/Booking/Edit.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuTeam("TeamDashboard/Booking/Edit.phtml",true,[
