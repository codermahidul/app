...
class AddAnnouncement
{
    ...
    function __construct()
   {
       ...
       $this->Main->SetTitle("Add Announcement");
       ...
       $Js='<script type="module" src="'.VIEW_PATH.'js/Admin/Setting/AddAnnouncement.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuAdmin("Setting/AddAnnouncement.phtml",true,
    [
