...
class productListAdmin{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/Confirm/Product.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuAdmin("Confirm/ProductListAdmin.phtml",["have_home_show"=>"false"]);
