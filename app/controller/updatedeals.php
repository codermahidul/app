...
class updateDeals{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/BusinessDashboard/Deals/Edit.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuBusiness("BusinessDashboard/Deals/Edit.phtml",true,[
           "listHref"=>"DealsList",
           "list"=>"Deals List",
       ]);
