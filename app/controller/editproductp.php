...
class editProductP{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/ProfessionalDashboard/Tables/EditProduct.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuProfessional("BusinessDashboard/Product/Edit.phtml",true,[
           "listHref"=>"ProductList",
           "list"=>"Product List",
