...
class couponLinkCodeP
{
    ...
    function __construct()
   {
       ...
       <script type="module" src="'.VIEW_PATH.'js/ProfessionalDashboard/Tables/CouponLinkCode.js?v='.VERSION.'"></script>';
      ...
      $this->Main->CreateViewHeaderFooterSideMenuProfessional("BusinessDashboard/Deals/DealsLinkCode.phtml",true,[
