...
class allComment{
    ...
    {
        $this->Main=new Main;
        $this->Main->SetTitle("All Comment");
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/Setting/Proof.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuAdmin("Setting/AllComment.phtml");
