...
class AddDealsP{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/ProfessionalDashboard/Tables/AddDeals.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuProfessional("BusinessDashboard/Deals/Add.phtml",true,[
           "listHref"=>"DealsListP",
           "list"=>"Deals List",
       ]);
