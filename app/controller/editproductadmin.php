...
class editProductAdmin{
    private $Main;
     function __construct()
    {
        $this->Main=new Main;
        $this->Main->SetTitle("Edit Product");
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/Tables/EditProduct.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuAdminUserView("BusinessDashboard/Product/Edit.phtml",true,[
           "listHref"=>"MyProductAdmin",
           "list"=>"Product List",
