...
class editJobP{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/ProfessionalDashboard/Tables/EditJob.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuProfessional("BusinessDashboard/Job/Edit.phtml",true,[
           "listHref"=>"JobListP",
           "list"=>"Job List",
       ]);
