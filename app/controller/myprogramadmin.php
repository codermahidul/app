...
class myProgramAdmin{
    private $Main;
     function __construct()
    {
        $this->Main=new Main;
        $this->Main->SetTitle("My Program List");
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/Tables/MyProgram.js?v='.VERSION.'"></script>';
        ...
        $this->Main->CreateViewHeaderFooterSideMenuAdmin("Program/MyProgramAdmin.phtml");
