...
class adSettingList{
    ...
    {
        $this->Main=new Main;
        $this->Main->SetTitle("Ad Setting List");
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/Ad/AdSettingList.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuAdmin("Ad/AdSettingList.phtml");
