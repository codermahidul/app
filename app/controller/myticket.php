...
class myTicket{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/Support/TicketList.js?v='.VERSION.'"></script>';
        $this->Main->SetJs($Js);
        ...
        switch($type)
        {
            case "userBusiness":{
                ...
                $this->Main->CreateViewHeaderFooterSideMenuBusiness("Support/TicketList.phtml",true,[
            ...
            case "userProfessional":{
                ...
                $this->Main->SetHeaders($Header);
                $this->Main->SetFooter($Footer);
                $this->Main->CreateViewHeaderFooterSideMenuProfessional("Support/TicketList.phtml",true,[
                    "listHref"=>"SupportList",
                    "list"=>"Support List",
                    "title_page"=>"Ticket List"
                ]);
            ...
            case "user":{
                ...
                $this->Main->SetHeaders($Header);
                $this->Main->SetFooter($Footer);
                $this->Main->CreateViewHeaderFooterSideMenu("Support/TicketList.phtml",true,[
                    "listHref"=>"SupportList",
                    "list"=>"Support List",
                    "title_page"=>"Ticket List"
                ]);
