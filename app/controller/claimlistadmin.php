...
class claimListAdmin{
    private $Main;
    function __construct()
    {
        $this->Main=new Main;
        $this->Main->SetTitle("Claim List Admin");
        ...
        <script type="module" src="'.VIEW_PATH.'js/Admin/Tables/ClaimListAdmin.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuAdmin("Tables/ClaimListAdmin.phtml");
