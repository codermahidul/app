...
class couponlist{
     ...
     function __construct()
    {
        ...
        <script type="module" src="'.VIEW_PATH.'js/BusinessDashboard/Coupon/Coupon.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuBusiness("BusinessDashboard/Coupon/CouponList.phtml",true,[
           "urlAdd"=>"AddCoupon"
       ]);
