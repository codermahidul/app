...
class businessShareCoupon
{
    ...
    function __construct()
    {
        ...
        $this->Main->SetTitle("Business Share Coupon");
        ...
        $data2 = $this->Curls->curl("Fetch/getShareCoupon", [
            "trash" => "0",
            "admin_confirm" => "1",
        ...
        $bigBanner=$this->GetData->GetBigBanner("couponShare");
