...
class IdentifyEmployeeList{
    private $Main;
     function __construct()
    {
        $this->Main=new Main;
        $this->Main->SetTitle("Identify Employee List");
        ...
        <script type="module" src="'.VIEW_PATH.'js/BusinessDashboard/Employee/EmployeeIdentify.js?v='.VERSION.'"></script>';
       ...
       $this->Main->CreateViewHeaderFooterSideMenuBusiness("BusinessDashboard/Employee/IdentifyEmployeeList.phtml");
