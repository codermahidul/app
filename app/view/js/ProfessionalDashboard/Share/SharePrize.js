...
const DtClass=new DataTable("dataTable","prizeTAble/get_all_share");
...
DtClass.ClickTable("share",(data)=>{
    ...
    SwalRemoveFetch("userBusinessAction/prizeShare",{idSearch:data.id},DtClass.Refresh,"Are You Sure Share this?","","info","Ok","",false);
