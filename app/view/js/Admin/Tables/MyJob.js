...
const DtClass=new DataTable("dataTable","jobTable/get_all_admin");
...
DtClass.ClickTable("updateImage",(data)=>{
    imageShow(data.id,"job/getDataAdmin")
})
...
DtClass.ClickTable("view",(data)=>{
    JobC.ViewInfo("job/getDataAdmin",{idSearch:data.id},()=>{$("#ModalView").modal("show")})
})
