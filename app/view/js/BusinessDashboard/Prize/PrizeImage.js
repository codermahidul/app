...
export const imageShow = (id,url="prize/getData") => {
    urls=url;
...
export const RemoveImage = (url="prize/deleteimage",for_user=false) => {
...
export const SetImages = (btns,url="prize/updateimage",for_user=false) => {
