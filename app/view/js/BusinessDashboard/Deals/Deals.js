import { RemoveImage, SetImages, imageShow } from "../Coupon/CouponImage.js";
...
const DtClass=new DataTable("dataTable","couponAble/get_all_deals");
...
DtClass.ClickTable("updateImage",(data)=>{
    imageShow(data.id,"deals/getData")
})
